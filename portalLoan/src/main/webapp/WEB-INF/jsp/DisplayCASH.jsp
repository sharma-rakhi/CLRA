			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="/portalbranch"
						class="btn btn-info btn-block">Home Page</a></li>&nbsp;
					<li class="nav-item"><a href="/getloan"
						class="btn btn-info btn-block">Get Loan</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="container ">
		...
		<div class="row">
			...
			<div class="input-group mb-3 col">
				...
				<input class="form-control" type="text" readonly="readonly"
					value="<c:out value="${Type.bankname }" />">
			</div>
		</div>
		<div class="row">
			<div class="input-group mb-4 col">
			...
			<div class="input-group mb-4 col">
				...
				<input class="form-control" type="text" readonly="readonly"
					value="<c:out value="${Type.interestrate }" />">
			</div>
			<div class="input-group mb-4 col">
				<div class="input-group-prepend">
					<button class="input-group-text" href="#">
				...
				<input class="form-control" type="text" readonly="readonly"
					value="<c:out value="${Type.lockperiod }" />">
			</div>
		</div>
		<div align="center">
