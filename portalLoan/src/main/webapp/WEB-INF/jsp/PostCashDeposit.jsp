...
<body class="bg-light" onload="myFunction()">
	...
	<nav class="navbar navbar-dark navbar-expand-lg bg-primary fixed-top">
		<div class="container">
			...
			data-target="#modal1">Logout</a></li>&nbsp;
					<li class="nav-item"><a href="/portalbranch" class="btn btn-primary btn-block">Home Page</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="container ">
		${ msg}
		<form:form modelAttribute="deposit" action="/postdeposit"
			method="post">
			<div align="center">
			...
			<div class="row mb-3">
				...
				<div class="input-group col">
					...
					<form:input path="collateralValue" id="collateralValue"
						placeholder="Enter collateralValue" cssClass="form-control"
			...
			<div align="center">
				<a href="#" class="btn btn-info btn center mb-2">CASH DEPOSIT</a>
			</div>
			<div class="row mb-3">
				<div class="input-group col">
					<div class="input-group-prepend">
			...
			<div align="center">
				<a href="#" class="btn btn-info btn center mb-2">CUSTOMER DETAILS</a>
			</div>
			<div class="row mb-3">
				<div class="input-group col">
					<div class="input-group-prepend">
