...
<title>ENTER LOAN DETAILS</title>
</head>
<body class="bg-light" onload="myFunction()">
	...
	<div class="container">
		<nav class="navbar navbar-dark navbar-expand-sm bg-primary fixed-top">
			<div class="container">
				<a href="#" class="navbar-brand"><h2>ENTER LOAN DETAILS</h2></a>
			</div>
		</nav>
	</div>
	...
	${msg}
		<div class="form-group ">
			<form method="post" action="postloan">
				<label><b>ENTER LOAN ID</b></label> <input type="number" id="loanid"
					class="form-control" name="loanid" min="1" required="required"><br>
